            ...
            <table class="table table-bordered" id="provinces_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $field->machine_name }}</td>
                        <td>
                            @if ($field->searchable == "true")
                                <span class="badge badge-success">{{ $field->searchable }}</span>
                            @else
                                <span class="badge badge-danger">{{ $field->searchable }}</span>
                            @endif

                        </td>
                        <td>
                            <a href="{{ route('field.edit', $field->id) }}" class="btn btn-sm">
