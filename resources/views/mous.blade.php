                ...
                <div class="col-3">
                    <div class="card mou_file_cards">
                        ...
                        <div class="card-footer p-4 bg-transparent">
                            <strong>
                                <span class="badge badge-info">{{ $mou->province }}</span>
                                <span class="badge badge-info">{{ $mou->year }}</span>
                                <span class="badge badge-info">{{ $mou->month }}</span>
                            </strong>
                            <div class="float-right">
                                <a href="{{ route('mou.edit', $mou->id) }}" class="btn btn-sm">
