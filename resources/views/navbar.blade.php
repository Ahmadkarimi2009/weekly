<div class="container-fluid px-0">
    <nav class="navbar navbar-expand-md navbar-light bg-white p-0"> <a class="navbar-brand mr-4" href="#"><strong>Ipso</strong></a> <button class="navbar-toggler mr-3" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"> <a class="nav-link" href="#" id="navbarDropdown3" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Event Types
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill-rule="evenodd" d="M5.22 8.72a.75.75 0 000 1.06l6.25 6.25a.75.75 0 001.06 0l6.25-6.25a.75.75 0 00-1.06-1.06L12 14.44 6.28 8.72a.75.75 0 00-1.06 0z"></path></svg>
                    </a>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row d-flex tab">
                                        ...
                                        <div class="d-flex flex-column"> <a class="dropdown-item" href="{{ route('event_types.index') }}">
                                                <h6 class="mb-0">View Event Types</h6> <small class="text-muted">All tools</small>
                                            </a> </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row d-flex tab">
                                        <div class="fa-icon text-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill-rule="evenodd" d="M15.5 11.75a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0zm1.444-.75a5.001 5.001 0 00-9.888 0H2.75a.75.75 0 100 1.5h4.306a5.001 5.001 0 009.888 0h4.306a.75.75 0 100-1.5h-4.306z"></path></svg>
                                        </div>
                                        <div class="d-flex flex-column"> <a class="dropdown-item" href="{{ route('event_types.create') }}">
                                                <h6 class="mb-0">Add New Event Type</h6> <small class="text-muted">All tools</small>
                                            </a> </div>
                                    </div>
                                </div>
                            </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="" id="" role="button" ">Gallery</a>
                </li>
