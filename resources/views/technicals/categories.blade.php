...
@section('content')
    <div class="container mt-5">
        <div class="row">
            <h1 class="col-12">Parent Categories</h1>
            @foreach ($categories as $category)
                @if ($category->parent == 'yes')
                    <div class="col-3">
                        <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                            <div class="card-header">
                                <h5 class="d-inline-block">{{ $category->name }}</h5>
                            ...
                            <div class="card-body">
                                @include('technicals.sub_categories', ['parent' => $category->id])
                            </div>
                        </div>
                    </div>
                @endif
        ...
        <div class="row mt-5">
            <h1 class="col-12">Child Categories</h1>
            @foreach ($categories as $category)
                @if ($category->parent == 'no')
                    <div class="col-3">
