...
@section('content')
    <div class="container">
        <h1 class="mt-5 text-success display-1">Trips</h1>
        ...
        <div class="card-columns mt-5">
            @foreach ($trips as $trip)
                <div class="card conferences_card mt-5">
                    ...
                    <div class="card-body">
                        <span class="badge badge-success">{{ $trip->start_date}} - {{ $trip->end_date}}</span>
                    </div>
                    <div class="card-footer">
                        <a href="{{ route('trip.show', $trip->id) }}">View More...</a>
                        <a href="{{ route('trip.edit', $trip->id) }}" class="btn btn-sm">
